  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--black)', color: 'var(--white)', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 52px', borderBottom: '1px solid var(--border)' }}>
        ...
        <Link href="/auth/signup" className="btn-tl" style={{ padding: '10px 22px', fontSize: 11 }}>Create Account</Link>
      </nav>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <div className="label-tl" style={{ marginBottom: 16 }}>Welcome back</div>
          <h1 style={{ fontWeight: 800, fontSize: 48, textTransform: 'uppercase', lineHeight: 0.9, marginBottom: 32 }}>
            Sign<br />
            <em style={{ fontStyle: 'normal', background: 'linear-gradient(135deg, #ff2233, #ff6600)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>In.</em>
          </h1>
          ...
          <p style={{ textAlign: 'center', marginTop: 24, color: 'var(--grey)', fontSize: 13 }}>
            ...
            <Link href="/auth/signup" style={{ color: '#ff2233', textDecoration: 'none' }}>Create one free</Link>
          </p>
        </div>
      </div>
    </div>
